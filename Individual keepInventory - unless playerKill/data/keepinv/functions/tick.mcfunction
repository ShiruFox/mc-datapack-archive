...
# On death
execute as @a[scores={killedByPlayer=1..}] run scoreboard players set @s keepInvDeathC 0
execute as @a[scores={killedByPlayer=1..}] run scoreboard players set @s killedByPlayer 0
